...
export const LeisArtPageTemplate = ({
  image,
  title,
  main,
}) => (
...
export default LeisArtPage

export const LeisArtPageQuery = graphql`
  query LeisArtPage($id: String!) {
